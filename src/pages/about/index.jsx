...
const AboutPage = () => {
  const aboutMe = [
    "I'm a full stack developer with more than three years of experience based in Istanbul.",
    "I am motivated by my belief in continuous learning and self-improvement, so I try to take advantage of learning opportunities in every situation. I enjoy learning new things and sharing my knowledge. This passion further strengthens my dedicated approach to continuous self-improvement.",
